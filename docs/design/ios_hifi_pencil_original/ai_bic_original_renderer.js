...
function feedback() {
  return [
    ...
    sectionTitle(24, 632, "Assessment"),
    ...assessmentLine(656, "Answered the question", "Strong"),
    ...assessmentLine(680, "Story fit", "Strong"),
    ...assessmentLine(704, "Personal ownership", "Weak"),
    ...assessmentLine(728, "Evidence and outcome", "Mixed"),
    ...assessmentLine(752, "Holds up under follow-up", "Weak"),
    frame(0, 748, W, 104, { fill: C.canvas }, []),
    primaryButton(24, 758, 214, "Redo this answer"),
    secondaryButton(248, 760, 121, "Skip redo"),
    homeIndicator(false),
  ];
}
